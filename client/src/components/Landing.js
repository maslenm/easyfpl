...
const Landing = () => (
  <>
    <header className="landing-header">
      <h1 className="landing-header__title">EasyFPL.</h1>
    </header>
    ...
    <section className="landing-content">
      ...
      <div className="feature-cards">
        <div className="feature-card">
          <header className="feature-card__title">Compare</header>
        ...
        <div className="feature-card">
          <header className="feature-card__title">Pick</header>
          <p className="feature-card__text-content">
        ...
        <div className="feature-card">
          <header className="feature-card__title">Save</header>
          <p className="feature-card__text-content">
      ...
      <div className="start-cta">
        <Link to="/Login" role="button" className="btn btn--start">
          Get Started
        </Link>
      </div>
    </section>
